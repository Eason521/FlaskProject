...
def upgrade():
    ...
    sa.Column('identify', sa.String(length=32), nullable=True),
    ...
    sa.ForeignKeyConstraint(['student_id'], ['user.identify_id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['teacher_id'], ['user.identify_id'], ),
    sa.PrimaryKeyConstraint('id')
    )
